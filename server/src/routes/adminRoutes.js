...
router.patch("/payments/:id/verify", validate(paymentReviewSchema), asyncHandler(adminController.verifyPayment));
router.patch("/ads/:id/publish", validate(adminPublishSchema), asyncHandler(adminController.publishAd));
